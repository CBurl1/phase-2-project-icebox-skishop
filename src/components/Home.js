    ...
    <Container>
      <Row>
        <Col>
          ...
          <p>
            What's up Shredder? Let's be real, if you're here shopping with us then you are the real deal! If you want to ski the toughest lines with the best and safest gear then you don't have to look any further.
            <br />
            <br />
            Check out our "About" section to learn more about Icebox
            <br />
            <br />
            Check out our Shop to see all the latest and greatest gear. If you are feeling a little lost, just head there!
            <br />
            <br />
